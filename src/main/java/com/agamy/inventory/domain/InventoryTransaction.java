...
public class InventoryTransaction extends AbstractAuditingEntity<Long> implements Serializable, Persistable<Long> {
    ...
    public InventoryTransaction date(Instant date) {
        this.setDate(date);
        return this;
    }
    ...
    public InventoryTransaction type(InventoryActionType type) {
        this.setType(type);
        return this;
    }
    ...
    public InventoryTransaction active(Boolean active) {
