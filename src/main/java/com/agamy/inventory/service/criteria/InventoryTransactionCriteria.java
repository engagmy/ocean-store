...
/**
 * Criteria class for the {@link com.agamy.inventory.domain.InventoryTransaction} entity. This class is used
 * in {@link com.agamy.inventory.web.rest.InventoryTransactionResource} to receive all the possible filtering options from
...
public class InventoryTransactionCriteria implements Serializable, Criteria {
    ...
    /**
     * Class for filtering InventoryActionType
     */
    public static class InventoryActionTypeFilter extends Filter<InventoryActionType> {

        public InventoryActionTypeFilter() {}

        public InventoryActionTypeFilter(InventoryActionTypeFilter filter) {
            super(filter);
        }

        @Override
        public InventoryActionTypeFilter copy() {
            return new InventoryActionTypeFilter(this);
        }
    }
    ...
    private InventoryActionTypeFilter type;
    ...
    public InventoryTransactionCriteria(InventoryTransactionCriteria other) {
        ...
        this.type = other.optionalType().map(InventoryActionTypeFilter::copy).orElse(null);
    ...
    public InventoryActionTypeFilter getType() {
        return type;
    }

    public Optional<InventoryActionTypeFilter> optionalType() {
        return Optional.ofNullable(type);
    }

    public InventoryActionTypeFilter type() {
        if (type == null) {
            setType(new InventoryActionTypeFilter());
        }
        return type;
    }

    public void setType(InventoryActionTypeFilter type) {
        this.type = type;
    }
