...
/**
 * Criteria class for the {@link com.agamy.inventory.domain.ProductCategory} entity. This class is used
 * in {@link com.agamy.inventory.web.rest.ProductCategoryResource} to receive all the possible filtering options from
...
public class ProductCategoryCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, active, createdBy, createdDate, lastModifiedBy, lastModifiedDate, productId, distinct);
    }
