...
import com.agamy.inventory.service.PurchaseQueryService;
import com.agamy.inventory.service.PurchaseService;
...
/**
 * REST controller for managing {@link com.agamy.inventory.domain.Purchase}.
 */
@RestController
...
public class PurchaseResource {
    ...
    public ResponseEntity<PurchaseDTO> createPurchase(@Valid @RequestBody PurchaseDTO purchaseDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/purchases/" + purchaseDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, purchaseDTO.getId().toString()))
            .body(purchaseDTO);
    }
