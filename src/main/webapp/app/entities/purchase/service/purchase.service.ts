...
type RestOf<T extends IPurchase | NewPurchase> = Omit<T, 'createdDate' | 'lastModifiedDate'> & {
...
export class PurchaseService {
  ...
  protected convertDateFromClient<T extends IPurchase | NewPurchase | PartialUpdatePurchase>(purchase: T): RestOf<T> {
    return {
      ...purchase,
      createdDate: purchase.createdDate?.toJSON() ?? null,
      lastModifiedDate: purchase.lastModifiedDate?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restPurchase: RestPurchase): IPurchase {
    return {
      ...restPurchase,
      createdDate: restPurchase.createdDate ? dayjs(restPurchase.createdDate) : undefined,
      lastModifiedDate: restPurchase.lastModifiedDate ? dayjs(restPurchase.lastModifiedDate) : undefined,
    };
  }
