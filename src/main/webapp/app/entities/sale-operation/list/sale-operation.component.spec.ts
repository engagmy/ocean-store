...
import { sampleWithRequiredData } from '../sale-operation.test-samples';
...
describe('SaleOperation Management Component', () => {
  let comp: SaleOperationComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(SaleOperationComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.saleOperations()[0]).toEqual(expect.objectContaining({ id: 25388 }));
  });

  describe('trackId', () => {
    it('should forward to saleOperationService', () => {
      const entity = { id: 25388 };
      jest.spyOn(service, 'getSaleOperationIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSaleOperationIdentifier).toHaveBeenCalledWith(entity);
