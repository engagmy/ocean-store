...
public class BrandTestSamples {
    ...
    public static Brand getBrandSample1() {
        return new Brand().id(1L).name("name1").createdBy("createdBy1").lastModifiedBy("lastModifiedBy1");
    }

    public static Brand getBrandSample2() {
        return new Brand().id(2L).name("name2").createdBy("createdBy2").lastModifiedBy("lastModifiedBy2");
    }
