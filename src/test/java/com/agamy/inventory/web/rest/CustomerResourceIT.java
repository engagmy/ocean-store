...
import static com.agamy.inventory.domain.CustomerAsserts.*;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity() {
        return new Customer().name(DEFAULT_NAME).phone(DEFAULT_PHONE).address(DEFAULT_ADDRESS).active(DEFAULT_ACTIVE);
    }
    ...
    public static Customer createUpdatedEntity() {
        return new Customer().name(UPDATED_NAME).phone(UPDATED_PHONE).address(UPDATED_ADDRESS).active(UPDATED_ACTIVE);
    }
    ...
    void putExistingCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).phone(UPDATED_PHONE).address(UPDATED_ADDRESS).active(UPDATED_ACTIVE);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).phone(UPDATED_PHONE).address(UPDATED_ADDRESS).active(UPDATED_ACTIVE);
