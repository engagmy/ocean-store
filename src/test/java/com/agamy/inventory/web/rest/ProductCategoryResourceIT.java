...
class ProductCategoryResourceIT {
    ...
    void getProductCategoriesByIdFiltering() throws Exception {
        ...
        defaultProductCategoryFiltering("id.greaterThanOrEqual=" + id, "id.greaterThan=" + id);

        defaultProductCategoryFiltering("id.lessThanOrEqual=" + id, "id.lessThan=" + id);
    }
    ...
    @Test
    @Transactional
    void getAllProductCategoriesByActiveIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedProductCategory = productCategoryRepository.saveAndFlush(productCategory);

        // Get all the productCategoryList where active equals to
        defaultProductCategoryFiltering("active.equals=" + DEFAULT_ACTIVE, "active.equals=" + UPDATED_ACTIVE);
    }

    @Test
    @Transactional
    void getAllProductCategoriesByActiveIsInShouldWork() throws Exception {
        // Initialize the database
        insertedProductCategory = productCategoryRepository.saveAndFlush(productCategory);

        // Get all the productCategoryList where active in
        defaultProductCategoryFiltering("active.in=" + DEFAULT_ACTIVE + "," + UPDATED_ACTIVE, "active.in=" + UPDATED_ACTIVE);
    }

    @Test
    @Transactional
    void getAllProductCategoriesByActiveIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedProductCategory = productCategoryRepository.saveAndFlush(productCategory);

        // Get all the productCategoryList where active is not null
        defaultProductCategoryFiltering("active.specified=true", "active.specified=false");
    }
